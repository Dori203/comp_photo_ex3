...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgs-dir-second', type=str, required=True)
    ...
    second = optimize_latent_codes_source_target(args, latent_code)
    second = second.reshape((1, 18, 512))

    latent_interp = (latent_code + second)/2
